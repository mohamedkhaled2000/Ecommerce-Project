...
<div class="container-full">
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="page-title">All Shipping District</h3>
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}"><i class="mdi mdi-home-outline"></i></a></li>
                            <li class="breadcrumb-item" aria-current="page">Shipping District</li>
                            <li class="breadcrumb-item active" aria-current="page">All Shipping District</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-md-8 col-sm-12">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">All Shipping District</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $district->district->shipping_name }}</td>
                                        <td>{{ $district->district_name }}</td>
                                        <td>
                                            <a class="btn btn-info" href="{{ route('district.edit',$district->id) }}">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a class="btn btn-danger" href="{{ route('district.delete',$district->id) }}" id="delete">
