    ...
    <div class="container">
      <div class="breadcrumb-inner">
        <ul class="list-inline list-unstyled">
          ...
          <li class='active'>
              {{ LaravelLocalization::getCurrentLocale() === 'ar' ?  $tag->product_tag_ar : $tag->product_tag_en }}
          </li>
          @endforeach
        </ul>
      </div>
      ...
      <div class='row'>
            ...
            <div class="sidebar-filter">
              ...
              <div class="sidebar-widget wow fadeInUp">
                ...
                <div class="widget-header">
                  <h4 class="widget-title">{{__('masseges.Categories')}}</h4>
                </div>
                <div class="sidebar-widget-body">
                  <div class="accordion">
                    @foreach ($categories as $category)
                        <div class="accordion-group">
                        <div class="accordion-heading"> <a href="#collapseOne{{$category->id}}" data-toggle="collapse" class="accordion-toggle collapsed">
                            {{LaravelLocalization::getCurrentLocale() === 'ar' ? $category->category_name_ar:$category->category_name_en}} </a> </div>
                        <!-- /.accordion-heading -->
                        @php
                            $subcategories = App\Models\SubCategory::where('category_id',$category->id)->orderBy('id','DESC')->get();
                        @endphp
                            ...
                            <div class="accordion-inner">
                                <ul>
                                    @foreach ($subcategories as $subcategory)
                                        <li><a href="#">{{LaravelLocalization::getCurrentLocale() === 'ar' ? $subcategory->subcategory_name_ar:$subcategory->subcategory_name_en}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
        ...
        <div class='col-md-9'>
          ...
          <div id="category" class="category-carousel hidden-xs">
            <div class="item">
              <div class="image"> <img src="{{asset('fontend/assets/images/banners/cat-banner-1.jpg')}}" alt="" class="img-responsive"> </div>
                  ...
                  <div class="category-product-inner wow fadeInUp">
                    ...
                    <div class="products">
                      <div class="product-list product">
                            ...
                            <div class="product-info">
                              ...
                              <div class="product-price">
                                  <span class="price">
                                    ...
                                    <span class="price-before-discount" style="color: rgb(126, 125, 125); display: {{ $amount == $product->selling_price ? 'none' : '' }}">
                                        $ {{ $amount }}
                                    </span> </div>
                              <!-- /.product-price -->
                              <div class="description m-t-10">
                                  {{ LaravelLocalization::getCurrentLocale() === 'ar' ?$product->short_desc_ar:$product->short_desc_en }}
                              </div>
                              <div class="cart clearfix animate-effect">
                                <div class="action">
                                  <ul class="list-unstyled">
                                    <li class="add-cart-button btn-group">
                                      ...
                                      <button class="btn btn-primary cart-btn" type="button">{{__('masseges.Add to cart')}}</button>
                                    </li>
                        ...
                        <!-- /.product-list-row -->
                        <div class="tag new"><span>-{{ $product->discount_price == null ? __('masseges.New') : round($discount) }}%</span></div>
                      </div>
                      <!-- /.product-list -->
                    </div>
                    <!-- /.products -->
