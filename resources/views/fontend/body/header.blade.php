          ...
          <div class="cnt-account">
            <ul class="list-unstyled">
              ...
              <li>
                  ...
                  @else
                  <a href="{{ url('/login') }}"><i class="icon fa fa-lock"></i>Login/Regster</a>
                  @endauth
                </li>
            </ul>
          </div>
                      ...
                      <li>
                        <div class="yamm-content">
                          <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner"> <a href="#"><img alt="" src="{{asset('fontend/assets/images/banners/banner-side.png')}}"></a> </div>
                          </div>
                          <!-- /.row -->
                        </div>
                        <!-- /.yamm-content --> </li>
